...
\begin{document}
	...
	% \small{
	 I have \textbf{more than 6 years of experience} in \textbf{knowledge transfer} between academia and industry. My diverse skill set includes problem-solving, automation, and simplifying complex ideas, using my expertise in \textbf{Data Science} and \textbf{Machine Learning}. This unique combination of skills has enabled me to address challenges across various sectors such as healthcare, energy, aerospace, and logistics.
	...
	\resumeItemListStart{}
	\resumeItem{Collaborating in three research initiatives:
		\begin{itemize}
			\item Building climate impact models simulating insurance risk under different SSP-RCP scenarios for strategic decision-making.
			\item Pioneering implementation of Kolmogorov-Arnold Networks (KANs) for weather forecasting, improving prediction accuracy.
			\item Designing optimization algorithms that reduce ship GHG emissions by leveraging real-time weather data.
		\end{itemize}}
	\resumeItem{Built and maintained IE Research Datalab's official website, increasing research visibility and collaboration opportunities.}
	\resumeItem{Delivered 4 courses (Computer Programming I, Coding Lab, Time Series Analysis, Applied Math Lab) to 100+ students with consistently high satisfaction ratings.}
	\resumeItemListEnd{}
	
	\resumeQuadHeading{COO}{Apr 2023 -- Present}
	{Canonical Green}{Madrid, Spain}
	\resumeItemListStart{}
	\resumeItem{Built and deployed data science solutions that enable maritime clients to optimize routes and reduce carbon emissions by up to 10\%.}
	\resumeItem{Delivered technical presentations that translated complex algorithms into business value.}
	\resumeItemListEnd{}
	
	\resumeQuadHeading{Data Scientist}{Sep 2022 -- Apr 2023}
	{Komorebi AI}{Madrid, Spain}
	\resumeItemListStart{}
	\resumeItem{Cleaned and processed 500K+ data points from raw sensor data, enabling accurate fish population monitoring for overfishing prevention.}
	\resumeItem{Designed and deployed gradient-boosted and CNN models using scikit-learn that achieved 90\%+ accuracy in real-time tuna detection.}
	\resumeItem{Built an interactive Streamlit dashboard that leadership used daily for operational decisions, reducing analysis time by 80\%.}
	\resumeItemListEnd{}
	
	\resumeQuadHeading{Predoctoral Research Staff}{Sep 2019 -- Aug 2022}
	{University of C\'adiz}{C\'adiz, Spain}
	\resumeItemListStart{}
	\resumeItem{Built machine learning models for Industry 4.0 applications in energy monitoring and sustainable fishing, reducing operational costs for industrial partners.}
	...
	\resumeItem{Published 5 peer-reviewed papers in Q1/Q2 journals, advancing the field of applied machine learning and data science.}
	\resumeItemListEnd{}
	...
	\resumeItemListStart{}
	\resumeItem{Pioneered application of Kolmogorov-Arnold Networks to weather forecasting, pushing the boundaries of ML-based meteorological prediction.}
	\resumeItem{Funded by the Spanish Ministerio de Ciencia, Educación y Universidades.}
	\resumeItemListEnd{}
	
	\resumeTrioHeading{Insurance and Tech}{Data Science, Actuarial Science}{IE University}
	\resumeItemListStart{}
	\resumeItem{Built predictive models analyzing climate change impact on insurance risk, providing VIG with data-driven strategies for portfolio adaptation.}
	\resumeItem{Partnered with Vienna Insurance Group (VIG) to bridge academic research and real-world insurance challenges, delivering actionable insights.}
	\resumeItemListEnd{}
	...
	\resumeItem{Funded by the BBVA Foundation and Spanish Agencia Estatal de Investigación (grant TED2021-129455B-I00).}
	\resumeItem{Built the official project website \href{https://weathernavigation.com/}{\uline{https://weathernavigation.com/}}.}
	\resumeItem{Presented technology directly to \href{https://www.youtube.com/watch?v=T2VRDSczxVM&t}{\uline{the European Parliament}}, positioning the innovation for EU-wide adoption.}
	\resumeItemListEnd{}
	
	\resumeTrioHeading{Tun-AI}{Deep Learning, Fishing Industry}{Komorebi AI}
	\resumeItemListStart{}
	\resumeItem{Partnered with Satlink to build AI-powered tuna monitoring systems that automated fish detection with 90\%+ accuracy.}
	\resumeItem{Transformed 500K+ raw echosounder readings into clean, structured datasets that powered machine learning models.}
	...
	\resumeItemListStart{}
	\resumeItem{Built a contactless monitoring system using Luxonis OAK-D cameras that assisted health experts in Neonatal Intensive Care Units (NICUs).}
	\resumeItem{Won 2nd place globally at \href{https://opencv.org/opencv-ai-competition-2021/\#regional-winners}{\uline{OpenCV AI Competition 2021}} among 1,400+ teams, demonstrating innovation and technical excellence.}
	\resumeItem{Secured \href{https://drive.google.com/file/d/1AN-C6Wb77trgd3riLIXcsKpQlfIfOlGk/view?usp=sharing}{\uline{official patent registration}} in 2023, protecting intellectual property for future commercialization.}
	\resumeItemListEnd{}
	...
	\resumeItemListStart{}
	\resumeItem{Designed a nanosatellite testing platform for space-based gravitational wave detectors like \href{https://www.elisascience.org/}{\uline{LISA}}, advancing next-generation astrophysics technology.}
	\resumeItem{Collaborated with a multidisciplinary team selected by ESA's \href{https://www.esa.int/Education/CubeSats_-_Fly_Your_Satellite}{\uline{Fly Your Satellite!}} programme, delivering results that met European Space Agency standards.}
	\resumeItemListEnd{}
	
	\resumeTrioHeading{ATENEA}{Computer Vision, Industrial Automation}{Univesidad de C\'adiz}
	\resumeItemListStart{}
	\resumeItem{Partnered with Airbus D\&S to deploy ML and NLP solutions that automated production processes, reducing manual inspection time.}
	\resumeItem{Funded by the CDTI Interconnecta program, delivering computer vision systems for Airbus.}
	\resumeItemListEnd{}
