...
\begin{document}
	...
	\resumeItemListStart{}
	\resumeItem{Main lines of research:
		\begin{itemize}
			\item Simulate the effect of climate change, under different SSP-RCP scenarios, on personal insurance.
			\item Implement the novel Kolmogorov-Arnold Networks (KANs) on weather forecasting.
			\item Mathematical optimization to reduce GHG emissions of ships using weather data.
		\end{itemize}}
	\resumeItem{Active member of IE Research Datalab; responsible for writing and designing the official website.}
	\resumeItem{Teaching courses in: Computer Programming I, Coding Lab, Time Series Analysis, and Applied Math Lab.}
	\resumeItemListEnd{}
	...
	\resumeItem{Delivering effective commercial and technical presentations.}
	\resumeItemListEnd{}
	...
	\resumeItemListStart{}
	\resumeItem{Kolmogorov-Arnold Networks with applications in weather forecasting}
	\resumeItem{Funded by the Spanish Ministerio de Ciencia, Educación y Universidades.}
	\resumeItem{I served as part of the research team.}
	\resumeItemListEnd{}
	
	\resumeTrioHeading{Insurance and Tech}{Data Science, Actuarial Science}{IE University}
	\resumeItemListStart{}
	\resumeItem{Explore the intersection of insurance, emerging technologies, and societal challenges such as climate change.}
	\resumeItem{This project was a collaboration between IE School of Science \& Technology and Vienna Insurance Group (VIG).}
	\resumeItem{I served as part of the research team.}
	\resumeItemListEnd{}
	...
	\resumeItem{I was invited to \href{https://www.youtube.com/watch?v=T2VRDSczxVM&t}{\uline{pitch this idea to the European Parliament}.}}
	\resumeItemListEnd{}
	
	\resumeTrioHeading{Tun-AI}{Deep Learning, Fishing Industry}{Komorebi AI}
	\resumeItemListStart{}
	\resumeItem{In collaboration with Satlink, a company specializing in echosounder buoys, this project aimed to enhance the monitoring of tuna populations to prevent overfishing.}
	\resumeItem{My role involved cleaning and processing raw data to be used in machine learning models.}
	\resumeItem{We employed gradient-boosted decision trees and convolutional neural networks, which were efficient enough for real-time fish monitoring.}
	\resumeItemListEnd{}
	...
	\resumeItem{The \href{https://drive.google.com/file/d/1AN-C6Wb77trgd3riLIXcsKpQlfIfOlGk/view?usp=sharing}{\uline{patent for NeoCam technology}} was officially registered under our names in 2023.}
	\resumeItemListEnd{}
	
	\resumeTrioHeading{COVID-19}{Time Series Forecasting, Healthcare}{Univesidad de C\'adiz}
	\resumeItemListStart{}
	\resumeItem{I collaborated with the Coordination Centre for Health Alerts and Emergencies in Spain to develop a model that could simulate and predict ICU bed occupancy by COVID-19 patients.}
	\resumeItem{We then used that information to study the effect of non-pharmaceutical interventions (NPIs) in the spread of COVID-19.}
	\resumeItemListEnd{}
