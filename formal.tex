...
\begin{document}
	...
	\resumeTrioHeading{NeoCam}{Machine Learning, Python}{Reference!}
	\resumeItemListStart{}
	\resumeItem{}
	\resumeItemListEnd{}
	...
	\resumeItemListStart{}
	\resumeItem{\href{https://openbadgefactory.com/v1/assertion/4d76a8035a509add2f9b01f1c19cdb9a0eef56ca.html}{\uline{Machine learning in Python with scikit-learn}}}
	
	\resumeItem{\href{https://www.coursera.org/account/accomplishments/specialization/WXQQSYVFLA78}{\uline{TensorFlow in Practice Specialization}}}
	%\resumeItem{\href{https://www.coursera.org/account/accomplishments/verify/FE4HNB2LFVRU}{\uline{Convolutional Neural Networks in TensorFlow}}}
	%\resumeItem{\href{https://www.coursera.org/account/accomplishments/verify/XG8F2HMXUH4V}{\uline{Introduction to TensorFlow for Artificial Intelligence, Machine Learning, and Deep Learning}}}
	%\resumeItem{\href{https://www.coursera.org/account/accomplishments/verify/FPHZBNAU29ZK}{\uline{Natural Language Processing in TensorFlow}}}
	%\resumeItem{\href{https://www.coursera.org/account/accomplishments/verify/DKX6PA6UFBQC}{\uline{Sequences, Time Series and Prediction}}}
	
	\resumeItem{\href{https://www.coursera.org/account/accomplishments/verify/JEZRF6VKSWUE}{\uline{Applied Social Network Analysis in Python}}}
	\resumeItem{\href{https://www.coursera.org/account/accomplishments/verify/HKSAYBJFPQGU}{\uline{Applied Machine Learning in Python}}}
	\resumeItem{\href{https://www.coursera.org/account/accomplishments/verify/PMFZNFG755X3}{\uline{Applied Text Mining in Python}}}
	\resumeItem{\href{https://www.coursera.org/account/accomplishments/verify/2SDFQS2HSAE3}{\uline{Introduction to Data Science in Python}}}
